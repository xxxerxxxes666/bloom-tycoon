...
3. **Pass 3 — Visual Polish and Feedback Discipline — CURRENT REQUIRED MILESTONE.** Improve tile/socket contrast and legibility; use one readable hit event per cascade wave; make Cursed Thorn damage unmistakable; keep Supreme Bloom rare; eliminate overlapping labels. Implement and verify this as one cohesive player-visible milestone; do not split it into tiny polish commits.

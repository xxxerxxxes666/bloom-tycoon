...
def verify_source_hooks():
    ...
    required.extend([
        ...
        "Bouquet ${progress.earned}/${progress.needed} -> Reward ${plan.reward.coins} coins",
        ...
        "Order Progress · ${progress.earned}/${progress.needed}",
        "Order Complete · ${progress.earned}/${progress.needed}",

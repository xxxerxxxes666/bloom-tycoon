...
def verify_source_hooks():
    ...
    required = [
        ...
        "Already owned · +${plan.reward.coins} coins · ${coins} coins balance.",
        "Permanent through replay",
        "Owned: Conservatory Raised",
        "RESTORED GREENHOUSE OWNED",
        "MOONLIT GREENHOUSE OWNED",
        "BLOODROOT CONSERVATORY OWNED",
        ...
        "options.restoreSelectionOnRefusal === false || resetThornLessonAfterRefusal ? null : source",

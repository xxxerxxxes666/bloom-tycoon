...
def verify_source_hooks():
    ...
    required = [
        ...
        "const ownedReplayCompletion = isOwnedRestorationReplay();",
        "? retainedOwnedReplayBalance",
        ...
        "const retainedOwnedReplayBalance = ownedReplayCompletion ? coins : null;",
    ...
    required.extend([
        ...
        "Nourish ${plan.reward.coins} · Keep ${coins}",
        "${plan.reward.coins} coins nourish the Conservatory; ${coins} coins kept",
        'rewardLabel: alreadyOwned ? "Reward reinvested" : "Exact reward"',
        'consequenceCopy: alreadyOwned ? `${coins} coins remain` : milestone.action',

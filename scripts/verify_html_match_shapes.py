...
def verify_source_hooks():
    ...
    required = [
        ...
        "applyGreenhouseArtwork(roundThreeFinalPayoff ? \"bloodroot\" : (roundTwoUpgradePending || roundTwoUpgradeComplete) ? \"moonlit\" : \"first\")",
        ...
        "Spend the Bloodroot payout to raise the crimson conservatory before replaying the first order.",

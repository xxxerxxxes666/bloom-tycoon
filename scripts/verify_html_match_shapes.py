...
def verify_source_hooks():
    ...
    required = [
        ...
        'payoffOwnsNarration || tutorialPanelOwnsNarration ? "off" : "polite"',
        ...
        "blackCandleOutcomeOwnsNarration",
        "function blackCandleThornOutcomeMessage",
        "function presentBlackCandleThornOutcomeCue",
        'Black Candle burned the ${lane}. Cursed Thorn ${progress} of ${needed}',

...
def verify_source_hooks():
    ...
    required = [
        ...
        "function isRoundThreeFirstHarvestHandoffActive(plan = activeRoundPlan())",
        "function primeRoundThreeFirstHarvestHandoff(plan = activeRoundPlan())",
        '"round-three-harvest-handoff-cue"',
        "body.round-three-focus-active.round-three-harvest-handoff-cue .first-swap-cue",
        "round-one-refused",

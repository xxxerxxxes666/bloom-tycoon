...
def verify_source_hooks():
    ...
    required = [
        ...
        "applyGreenhouseArtwork(roundThreeFinalComplete ? \"bloodroot\" : (roundTwoUpgradePending || roundTwoUpgradeComplete) ? \"moonlit\" : \"first\")",
        ...
        "Spend ${MOONLIT_GREENHOUSE_UPGRADE_COST} coins to raise the Moonlit Greenhouse before Bloodroot Compact.",
        ...
        "The bouquet paid for the relit glass. One tap starts the Moonlit Wreath order.",
        ...
        "isRestoredNextOrderFocus() || failedFocusedRestoredOrder",

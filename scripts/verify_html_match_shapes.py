...
def verify_source_hooks():
    ...
    required = [
        ...
        "const returnCue = focusedCueActive ? cue.textContent :",
        "const returnHintCells = focusedCueActive ? new Set(hintSnapshot) : new Set()",
        ...
        "markInvalidSwap(source, target, selectedHintPair)",

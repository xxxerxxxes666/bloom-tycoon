...
html_checks = {
    ...
    "function craftedBouquetEntries": "shared six-slot bouquet target composition",
    'class="live-bouquet-ingredient live-bouquet-bloom': "six-slot live bouquet bloom renderer",
